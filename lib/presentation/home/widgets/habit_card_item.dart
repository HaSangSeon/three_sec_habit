...
/// 습관 카드 아이템 (단순 체크형 기본 + 선택적 목표 횟수형 지원)
...
class _HabitCardItemState extends State<HabitCardItem>
  ...
  void initState() {
    ...
    _scaleAnimation = TweenSequence<double>([
      ...
      TweenSequenceItem(
        tween: Tween<double>(begin: 0.84, end: 1.10)
            ...
            children: [
              Row(
                children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  habitColor.withValues(alpha: isDone ? 0.15 : 0.28),
                                  habitColor.withValues(alpha: isDone ? 0.08 : 0.14),
                                ],
                              ...
                              border: Border.all(
                                color: habitColor.withValues(alpha: isDone ? 0.2 : 0.4),
                                width: 1.2,
                              ),
                            ),
                            child: Icon(
                              AppIcons.getIcon(habit.iconName),
                              color: isDone ? habitColor.withValues(alpha: 0.7) : habitColor,
                              size: 24,
                            ),
                          ),
                                  ...
                                  children: [
                                    ...
                                    if (habit.reminderEnabled &&
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          '${(habit.reminderIntervalMinutes ?? 60) ~/ 60}시간마다 알림',
                  ...
                  // 2. 우측 완성도 높은 완료 인터랙션 영역
                  Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      // 카운트형 감소 버튼 (오늘 카운트가 1 이상일 때)
